...
var idp_options = {
    sso_login_url: "https://fidm.us1.gigya.com/saml/v2.0/3_KyWYMTqW8wGu68u64-CMNEe-OwheA9CDbQz1jY3kZHHyj8YCXaXk0IZDWjlXN-UZ/idp/sso",
    sso_logout_url: "https://fidm.us1.gigya.com/saml/v2.0/3_KyWYMTqW8wGu68u64-CMNEe-OwheA9CDbQz1jY3kZHHyj8YCXaXk0IZDWjlXN-UZ/idp/slo"//,
...
app.post("/acs", function (req, res) {
    ...
    var options = {request_body: req.body,
                   audience: "https://sp.local/metadata.xml",
...
app.get("/slo", function (req, res) {
    ...
    p.redirect_assert(idp, options, function (err, saml_response) {
